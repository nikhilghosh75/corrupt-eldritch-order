...
/*
 * Code taken from https://github.com/ZoserLock/unity-editor-tools/blob/master/Assets/Scripts/Editor/EditorGUITools.cs
 */
...
public class EditorGUITools
{
    ...
    /// </summary>
    public static void DynamicScroll<T>(EditorWindow editor, DynamicScrollData data, List<T> elements, System.Func<T, int, int> layout, System.Action<T, int> drawFunction)
    {
        ...
        if (Event.current.type == EventType.Repaint && editor != null)
        {
